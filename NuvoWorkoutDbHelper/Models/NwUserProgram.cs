...
public class NwUserProgram
{
    ...
    {
        modelBuilder.Entity<NwUserProgram>(entity =>
        {
            ...
            entity.Property(e => e.NwUserId).HasColumnName("nw_user_id").HasColumnType("bigint").IsRequired(false);
        });
    }
}